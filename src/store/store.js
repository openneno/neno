...
export const settingStrore = writable({ platform: "七牛", imgDomain: "http://img.neno.topmini.top", domain: "https://api.neno.topmini.top", useMode: "github" });
export const githubStrore = writable({ access_token: "", refresh_token: "", refresh_token_expires_in: 0, repoName: "", branch: "master", githubName: "",lastCommitSha:"" });
...
export const pushToGithubTag = writable({ timestmp: 0,data:{} });
