...
<div
    class="border-gray-200 border-solid border-4 rounded-lg mt-2 flex flex-col justify-start  pb-2"
>
    ...
    <div class=" flex justify-between  pl-3 pr-3">
        <div id="toolbar" class="space-x-2">
            <button
        ...
        <button
            class="rounded-sm bg-green-500 text-white pl-2 pr-2"
